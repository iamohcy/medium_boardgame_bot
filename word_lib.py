...
WORD_LIST = ["Hollywood","Well","Foot","New York","Spring","Court","Tube","Point","Tablet","Slip","Date","Drill","Lemon","Bell",
...
"Watch","Lead","Tie","Table","Cell","Cover","Back","Bomb","Ruler","Forest","Bottle",
...
"Spirit","Cable","Swamp","Einstein","Hide","Crystal","Gear","Kiss","Pew","Powder","Turtle","Bacon","Sherlock","Squash",
"Book","Razor","Dressing","Brick","Brazil","Tear","Stable","Bikini","Pen","Roll","Christmas","Rubber","Bay","Mother",
"Kick","Fog","Radio","Crab","Cone","Skull","Wheelchair","Egg","Butter","Werewolf","Cherry","Patient","Dryer","Drawing",
"Boss","Fever","Banana","Polish","Knot","Paint","Storm","Goldilocks","Pillow","Chain","Moses","Saw","Brother","Rail",
"Rope","Street","Pad","Captain","Wish","Axe","Shorts","Popcorn","Castle","Second","Team","Oasis","Mess","Miss",
"Avalanche","Texas","Sun","Letter","Rust","Wing","Steel","Ear","Scroll","Bunk","Cane","Venus","Ladder","Purse",
"Sheet","Napoleon","Sugar","Director","Ace","Scratch","Bucket","Caesar","Disk","Beard","Bulb","Bench","Scarecrow","Igloo",
"Tuxedo","Earth","Ram","Sister","Bread","Record","Dash","Greenhouse","Drone","Steam","Biscuit","Rip","Notre Dame","Lip",
"Shampoo","Cheese","Sack","Mountie","Sumo","Sahara","Walrus","Dust","Hammer","Cloud","Spray","St.Patrick","Kilt","Monkey",
"Frog","Dentist","Rainbow","Whistle","Reindeer","Kitchen","Lemonade","Slipper","Floor","Valentine","Pepper","Road","Shed","Bowler",
"Milk","Wheel","Magazine","Brass","Tea","Helmet","Flag","Troll","Jail","Sticker","Puppet","Chalk","Bonsai","Sweat",
"Gangster","Butterfly","Story","Salad","Armor","Smoke","Cave","Quack","Break","Snake","Mill","Gymnast","Wonderland","Driver",
"Spurs","Zombie","Pig","Cleopatra","Toast","Penny","Ant","Volume","Lace","Battleship","Maracas","Meter","Sling","Delta",
"Step","Joan of Arc","Comet","Bath","Polo","Gum","Vampire","Ski","Pocket","Battle","Foam","Rodeo","Squirrel","Salt",
"Mummy","Blacksmith","Chip","Goat","Laundry","Bee","Tattoo","Russia","Tin","Map","Yellowstone","Silk","Hose","Sloth",
"Kung Fu","Clock","Bean","Lightning","Bowl","Guitar","Ranch","Pearl","Flat","Virus","Ice Age","Coffee","Marathon","Attic",
"Wedding","Columbus","Pop","Sherwood","Trick","Nylon","Locust","Pacific","Cuckoo","Tornado","Memory","Jockey",
"Minotaur","Big Bang","Page","Sphinx","Crusader","Volcano","Rifle","Boil","Hair","Bicycle","Jumper","Smoothie",
"Sleep","Pentagon","Groom","River","Farm","Judge","Viking","Easter","Mud","Parrot","Comb","Salsa",
"Eden","Army","Paddle","Saloon","Mona Lisa","Mile","Blizzard","Quarter","Jeweler","Hamburger","Glasses","Sail",
"Boxer","Rice","Mirror","Ink","Beer","Tipi","Makeup","Microwave","Hercules","Sign","Pizza","Wool",
"Homer","Minute","Sword","Soup","Alaska","Baby","Potter","Shower","Blade","Noah","Soap","Tunnel",
"Peach","Dollar","Tip","Love","Jellyfish","Stethoscope","Taste","Fuel","Mosquito","Wizard","Big Ben","Garden",
"Waitress","Shoot","Shell","Lumberjack","Medic","Dream","Blues","Earthquake","Pea","Parade","Sled","Smell",
"Computer","Cow","Peanut","Window","Mustard","Sand","Golf","Crow","Iceland","Apron","Violet","Door",
"Tiger","Joker","House","Collar","Hawaii","Dwarf","Pine","Magician","Frost","Curry","Bubble","Wood"]

def getWords():
    wordA = random.choice(WORD_LIST)
    wordB = wordA
    while (wordA == wordB):
        wordB = random.choice(WORD_LIST)
